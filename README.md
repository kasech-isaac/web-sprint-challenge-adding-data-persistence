...
`SQL is a structure Query Language.It is the standard language for relational database management systems. SQL statements are used to perform tasks such as update data on a database, or retrieve data from a database. `

2. Why do tables need a `primary key`?
`primary key is needed to identify columns of table which should be uniqe.`

3. What is the name given to a table column that references the primary key on another table.
`foreign key(fk)`
4. What do we need in order to have a _many to many_ relationship between two tables.
`3rd table called intermediary/join table`
